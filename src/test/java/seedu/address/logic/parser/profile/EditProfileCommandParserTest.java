...
import static seedu.address.testutil.TypicalIndexes.INDEX_THIRD_PROFILE;
...
public class EditProfileCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified
        assertParseFailure(parser, "1", EditProfileCommand.MESSAGE_NOT_EDITED);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditProfileDescriptor descriptor = new EditProfileDescriptorBuilder().withName(VALID_NAME_AMY)
    ...
    public void parse_oneFieldSpecified_success() {
        // name
        Index targetIndex = INDEX_THIRD_PROFILE;
        String userInput = targetIndex.getOneBased() + NAME_DESC_AMY;
        EditProfileDescriptor descriptor = new EditProfileDescriptorBuilder().withName(VALID_NAME_AMY).build();
        EditProfileCommand expectedCommand = new EditProfileCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // phone
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY;
        descriptor = new EditProfileDescriptorBuilder().withPhone(VALID_PHONE_AMY).build();
        expectedCommand = new EditProfileCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // email
        userInput = targetIndex.getOneBased() + EMAIL_DESC_AMY;
        descriptor = new EditProfileDescriptorBuilder().withEmail(VALID_EMAIL_AMY).build();
        expectedCommand = new EditProfileCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // tags
        userInput = targetIndex.getOneBased() + TAG_DESC_FRIEND;
        descriptor = new EditProfileDescriptorBuilder().withTags(VALID_TAG_FRIEND).build();
        expectedCommand = new EditProfileCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_resetTags_success() {
        ...
        EditProfileDescriptor descriptor = new EditProfileDescriptorBuilder().withTags().build();
        EditProfileCommand expectedCommand = new EditProfileCommand(targetIndex, descriptor);
